...
export const registerSchema = z.object({
    ...
    .trim()
    .regex(/^\+[1-9]\d{7,14}$/, "Nomor telepon harus diawali kode negara, contoh: +628123456789",),

    gender: z.enum(["male", "female"], {message: "Jenis kelamin wajib dipilih",}),

    terms_accepted: z.literal(true, {message: "Kamu harus menyetujui syarat dan ketentuan",}),
});
